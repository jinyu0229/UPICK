...
<head>
    ...
    <!-- memPrivacyPolicy.css -->
    <link rel="stylesheet" href="/Upick/css/memPrivacyPolicy.css">
</head>
        ...
        <div class="memberCen_HC">
            ...
            <div class="memLeftMenu_HC">
                <ul>
                    ...
                    <li><a href="/Upick/web/member/memPrivacyPolicy.php" class="memChange_HC">隱私權政策</a></li>
            ...
            <div class="memRightCon">
                <div class="memberTitle_HC">
                    ...
                    <h1 class="memberTitleText_HC">隱私權政策</h1>
